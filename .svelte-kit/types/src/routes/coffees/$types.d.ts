...
export type PageServerData = Expand<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../node_modules/@sveltejs/kit/src/routes/coffees/+page.server.js').load>>>>;
